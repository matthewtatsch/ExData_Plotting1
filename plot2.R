##   plot2 loads and reads data from the "electric power consumption" dataset 
##   from the UC Irvine Machine Learning Repository, and creates a plot in line 
##   with instruction at https://github.com/rdpeng/ExData_Plotting1/blob/master/README.md.  
...
##   plot2 takes a data frame and creates a PNG line plot of Global Active Power 
plot2 <- function(df) {
     png(file = "plot2.png")
...
##   plot3 takes a data frame and creates a PNG plot of
plot3 <- function(df) {
     png(file = "plot3.png")
