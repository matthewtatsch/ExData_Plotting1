##   plot1 loads and reads data from the "electric power consumption" dataset 
...
##   plot takes a data frame and creates a PNG plot of a basic histogram 
plot1 <- function(df) {
     png(file = "plot1.png")
